...
public final class CustomerDetails extends javax.swing.JFrame {
    ...
    public void ShowTable(){
     try{
         ...
         while(rs.next()){
             ...
             Object[] content = {customerId, fName, lName, age, status, gender, address, NIC, phone, email };
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Customer Details List");
    ...
    private void SearchCustomerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SearchCustomerActionPerformed
        SearchCustomer s_customer =new SearchCustomer();
       s_customer.setVisible(true);
