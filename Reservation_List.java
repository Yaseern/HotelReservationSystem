 ...
 Connection conn = new DBConnection().connect();
     ...
     try{
        ...
        Connection con = (Connection)
         ...
         while(rs.next()){
             ...
             String Reservation_No = rs.getString(1);
          ...
          /*   SimpleDateFormat SimpleFormat = new SimpleDateFormat("yyyy-MM-dd", Locale.getDefault());
             String CheckInDate = SimpleFormat.format(rs.getString(3);
             String CheckOutDate = SimpleFormat.format(rs.getString(4));*/
             
             Object[] content = {Reservation_No, Customer_Id, Check_IN, Check_OUT, Room_Type, RoomID, TotalBill, Status };
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Reservation_NO", "Customer_ID", "Check_In", "Check_Out", "Room_Type", "Room_ID", "Total_Bill", "Status"
            }
        ) {
